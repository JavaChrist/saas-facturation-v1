...
// Configuration des plans (ces prix doivent être créés dans le dashboard Stripe)
const PLANS = {
  premium: process.env.STRIPE_PREMIUM_PRICE_ID || "price_xxxxx",
  entreprise: process.env.STRIPE_ENTREPRISE_PRICE_ID || "price_yyyyy",
};
